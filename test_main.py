"""Test the main function in main.py"""
...
def mock_functions(monkeypatch):
    """Monkeypatch to replace the functions 'login', 'transfer_money',
    'select_menu' and 'create_ticket' in main"""

    def dummy_login():
        """Dummy function to replace the function 'login' in main"""
        return {'name': 'Max', 'balance': 100}

    def dummy_transfer(person):
        """Dummy function to replace the function 'transfer_money' in main"""
        person['balance'] += 50  # Simulate adding 50 units of currency
    ...
    def dummy_ticket(person):
        ...
        person['balance'] -= 10  # Simulate deducting 10 units for a ticket
        return {'numbers': [1, 2, 3, 4, 5], 'price': 10}
